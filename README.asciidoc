...
We have docker image that runs the `mqsicreatebar` command in headless mode. See link:https://github.com/ace-hello-world/pipeline-guide/blob/master/code/image/mqsicreatebar[mqsicreatebar] how to create the docker image.
